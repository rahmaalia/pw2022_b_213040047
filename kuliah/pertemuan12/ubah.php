<?php 
    ...
    // query data mahasiswa berdaskan id
    $id = $_GET["id"];
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <a href="index.php" class="">Kembali ke data mahasiswa</a>
            ...
            <div class="col-8">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="npm" class="form-control" id="npm" required maxlength="9" minlength="9" style="width: 150px;" value="<?= $mhs["npm"]; ?>" >
                    </div>    
                    <div class="mb-3">
