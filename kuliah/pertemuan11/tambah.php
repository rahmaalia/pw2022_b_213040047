...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <a href="kuliah_latihan1.php" class="">Kembali ke data mahasiswa</a>
            ...
            <div class="col-8">
                <form action="" method="post" autocomplete="off">
                    <div class="mb-3">
                        ...
                        <input type="text" name="npm" class="form-control" id="npm" required maxlength="9" minlength="9" style="width: 150px;" >
                    </div>    
                    <div class="mb-3">
